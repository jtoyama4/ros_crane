...
class RL(object):
    ...
    def build_actor_network(self):
        ...
        final_model.add(Dense(10, activation='relu', input_dim=self.sensor_dim))
    ...
    def build_training_op(self):
        ...
        capped_gvs = [(tf.clip_by_value(gra, -1., 1.), var) for gra, var in gvs]
        ...
        capped_grads =[(tf.clip_by_value(gra, -1., 1.), var) for gra, var in grads]
